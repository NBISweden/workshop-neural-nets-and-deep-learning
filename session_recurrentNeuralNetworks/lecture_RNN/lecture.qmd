...
:::: {.fragment .center data-fragment-index="2" style="border-left: 2px black solid;"}
...
[A B C ... X Y Z]{style="font-size: 2em; text-align: center; font-family: DejaVu Sans Mono;"} 
...
[Z Y X ... C B A]{style="font-size: 2em; text-align: center; font-family: DejaVu Sans Mono;"} 
...
::::::::::::::::::: {style="display: grid; grid-template-columns: 400px auto; grid-column-gap: 10px; align-items: center;"}
...
### Example: Box & Jenkins airline passenger data set {.smaller}
...
FIXME: incrementally add the numbers to the network
...
:::: {.fragment .center style="font-size: 0.8em"}
